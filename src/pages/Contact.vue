<template>
  <Layout>
    ...
    <div class="container flex mx-auto my-8">
      <div class="flex flex-wrap items-center justify-center w-1/2 py-12 px-12">
        <div class="w-full md:w-1/2 mb-12 flex flex-col items-center text-center">
        ...
        <div class="w-full md:w-1/2 mb-12 flex flex-col items-center text-center">
          ...
          <div class="pl-4 py-4">
            ...
            <p><strong>Weekend</strong> By Appointment</p>
          </div>
        </div>
      </div>
      <ContactForm class="w-1/2"></ContactForm>
    </div>
  </Layout>
</template>
