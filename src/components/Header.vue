    ...
    <header class="w-full h-32 mx-auto shadow-lg font-display sticky top-0 z-10 bg-white">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <nav class="flex lg:hidden font-display text-xl text-gray-800 font-bold" id="mobileNav">
                <font-awesome :icon="['fas', 'bars']" v-if="!isOpen" @click="toggleMenu" size="2x" class="mr-4 text-gc-dark-grey"/>
                <font-awesome :icon="['fas', 'times']" v-if="isOpen" @click="toggleMenu" size="2x" class="mr-4 text-gc-dark-grey"/>
                <ul v-if="isOpen" class="flex flex-col w-64 bg-white mt-32 w-full absolute top-0 left-0 shadow-lg">
                    ...
                    <li class="mx-8 pl-4 py-4 hover:text-gc-yellow transition-color border-b">
                        ...
                        <ul v-if="submenuOpen">
                            <li @click="toggleMenu" class="ml-4 py-2 border-b text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#seniorDebtFinance">Senior Debt Finance</g-link></li>
                            <li @click="toggleMenu" class="ml-4 py-2 border-b text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#mezzanineFinance">Mezzanine Finance</g-link></li>
                            <li @click="toggleMenu" class="ml-4 py-2 border-b text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#developmentSales">Development Sales</g-link></li>
                            <li @click="toggleMenu" class="ml-4 py-2 border-b text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#grangeCapitalInvestmentFund">Grange Capital Investment Fund</g-link></li>
                            <li @click="toggleMenu" class="ml-4 py-2 border-b text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#gcImfDevelopmentFund">IMF Development Fund</g-link></li>
                            <li @click="toggleMenu" class="ml-4 py-2 text-gc-dark-grey hover:text-gc-yellow transition-color"><g-link to="/business/#gTelecom">Grange Telecom</g-link></li>
                        </ul>
                    </li>
